  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="relative mx-auto max-w-5xl bg-gradient-to-tr from-blue-600 to-primary rounded-3xl p-1 shadow-2xl overflow-hidden">
            <div className="relative aspect-[16/9] rounded-[22px] overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex items-end p-8">
                <span className="text-white font-semibold text-lg">Digital Impact Showcase — Empowering Young Minds</span>
              </div>
            </div>
          </div>
        </motion.div>
